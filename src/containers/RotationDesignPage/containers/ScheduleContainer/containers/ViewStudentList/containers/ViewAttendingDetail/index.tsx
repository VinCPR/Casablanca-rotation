...
export default function ViewAttendingDetail({ data }: Props) {
  function getFullName(data: AttendingInfo | undefined): string {
    if (data) {
    ...
    <div>
      ...
      <div className={styles.personalInfoContainer}>
        ...
        <div className={styles.personalnfo}>
          ...
          <div className={styles.rowContainer}>
            <div className={styles.boldText}>Attending ID: </div>
            <div className={styles.text}> {data?.attending_id} </div>
          </div>
          <div className={styles.rowContainer}>
