                    ...
                    <button
                      ...
                      onClick={() => {
                        const departments = data?.department
                          .selectedComponents as Department[];
                        ...
                        const services = data?.service
                          .map((value) =>
                            value
                              .map((column) => column.selectedComponents)
                              .flat()
                          )
                          .flat() as Service[];
                        const inputFormated = {
                        ...
                        console.log(
                          "design rotation",
                          designRotation(
                            { departments, hospitals, services },
                            3
                          )
                        );
                        // TODO: sketch the data generated by the `designRotation` function
                      }}
                    >
                      Preview
                    </button>
